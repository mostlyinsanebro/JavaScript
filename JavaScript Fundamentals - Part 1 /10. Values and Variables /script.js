...
// and variables are basically used to store those values.
// Variables are like boxes with tables and values are what is inside those boxes
// and those values can be accessed using the variable names.

let firstName = 'Abhinav';
console.log(firstName);
console.log(firstName);

// Also, for the syntax for variables, use camel casing and also do not use
...
// & is not allowed in variable names and we can not start them with numbers as well.
